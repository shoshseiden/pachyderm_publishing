...
<head>
    ...
    <title>Coverage for /Users/shoshseiden/Development/Envs/pachyderm_publishing/lib/python2.7/site-packages/django/db/backends/base/operations.py: 52%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/Users/shoshseiden/Development/Envs/pachyderm_publishing/lib/python2.7/site-packages/django/db/backends/base/operations.py</b> :
...
<p id="t400" class="stm run hide_run">&nbsp; &nbsp; &nbsp; &nbsp; <span class="key">return</span> <span class="op">[</span><span class="op">]</span>&nbsp; <span class="com"># No sequence reset required by default.</span><span class="strut">&nbsp;</span></p>
